...
ОРГАНИЗАЦИЯ:
- Во всём документе (шапка, преамбула, область применения, права и обязанности) указывай организацию ТОЛЬКО под наименованием из вводных данных («Наименование организации в документе»), например: ООО «DialgAI».
...
- названия организаций и подразделений;
- адреса;
