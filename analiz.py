...
def analyze_vnd(
    ...
    try:
        ...
        if pre_analysis and force_analysis:
            stage = "report"
            logger.info("Полный отчёт: используется агент-редактор отчёта (этап report)")
        else:
        ...
        max_tokens = 4096 if (pre_analysis and force_analysis) or stage == "report" else 2000
